...
class DashboardController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        return view('admin-views.dashboard', compact('data', 'total_sell', 'commission', 'params' ,'user'));
    }
    ...
    public function zone(Request $request)
    {
        ...
        return response()->json([
            ...
            'order_stats' => view('admin-views.partials._dashboard-order-stats', compact('total_sell','commission'))->render(),
    ...
    public function dashboard_data()
    {
        ...
        if ($params['zone_id'] != 'all') {
            ...
            $total_sell = DB::table('attendance')->where('zone_id',$params['zone_id'])->where('date', date('Y-m-d'))
            ->groupBy('employee_id')->count('id');
            $commission = DB::table('admins')->where('zone_id',$params['zone_id'])->count('id');
            ...
            $total_sell = DB::table('attendance')->where('date', date('Y-m-d'))
            ->groupBy('employee_id')->count('id');
            $commission = DB::table('admins')->count('id');
